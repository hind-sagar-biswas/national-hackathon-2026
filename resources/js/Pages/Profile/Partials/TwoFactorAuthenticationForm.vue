...
import { enable, qrCode as qrCodeRoute, secretKey, recoveryCodes as recoveryCodesRoute, confirm, disable } from '@/routes/two-factor';
...
const showQrCode = () => {
    return axios.get(qrCodeRoute().url).then(response => {
        qrCode.value = response.data.svg;
    });
};

const showSetupKey = () => {
    return axios.get(secretKey().url).then(response => {
        setupKey.value = response.data.secretKey;
    });
}

const showRecoveryCodes = () => {
    return axios.get(recoveryCodesRoute().url).then(response => {
        recoveryCodes.value = response.data;
    });
};

const confirmTwoFactorAuthentication = () => {
    confirmationForm.post(confirm(), {
        ...
        <template #content>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <FormField name="code" :error="confirmationForm.errors.code" v-if="confirming" class="mt-4">
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-base-300 rounded-lg">
            ...
            <div class="mt-5">
                <div v-if="!twoFactorEnabled">
                    <ConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <Button color="primary" type="button" :class="{ 'opacity-25': enabling }" :disabled="enabling">
                            Enable
                        </Button>
                    </ConfirmsPassword>
                </div>
                ...
                <div v-else>
                    <ConfirmsPassword @confirmed="confirmTwoFactorAuthentication">
                        <Button color="primary" v-if="confirming" type="button" class="me-3"
                    ...
                    <ConfirmsPassword @confirmed="regenerateRecoveryCodes">
                        <Button color="secondary" v-if="recoveryCodes.length > 0 && !confirming" class="me-3">
                    ...
                    <ConfirmsPassword @confirmed="disableTwoFactorAuthentication">
                        <Button color="secondary" v-if="confirming" :class="{ 'opacity-25': disabling }"
                            :disabled="disabling">
                            Cancel
                        </Button>
                    </ConfirmsPassword>
                    ...
                    <ConfirmsPassword @confirmed="disableTwoFactorAuthentication">
                        <Button color="error" v-if="!confirming" :class="{ 'opacity-25': disabling }"
                            :disabled="disabling">
                            Disable
                        </Button>
                    </ConfirmsPassword>
