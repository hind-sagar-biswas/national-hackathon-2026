...
<template>
    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            <FormField name="code" label="Code" :error="form.errors.code" v-if="!recovery">
            ...
            <FormField name="recovery_code" label="Recovery Code" :error="form.errors.recovery_code" v-else>
